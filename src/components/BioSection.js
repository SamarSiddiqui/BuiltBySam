...
const BioSection = () => {
  ...
  useGSAP(()=>{
let inspiringText = document.querySelector(".inspiring-text");
...
inspiringText.innerHTML = clutter;
  ...
  return (
    <div className='min-h-screen flex largerMobile:block largerMobile:mb-10'>
      ...
      <p className=''>Driven by a passion for understanding how things work behind the scenes, I found my calling in front-end development. My goal is simple yet profound: to make the internet a more beautiful, functional, and engaging place for everyone.</p>
      </div>
      </div>
    </div>
  )
